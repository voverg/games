    ...
    'help': `
      <h2 class="modal__title">Помощь</h2>
        <ul class="help-modal__list">
          ...
          <li class="help-modal__item">В первых 3-х уровнях змейка может проходить сковзь стены, начиная с 4-го уровня границы игрового поля становятся препятствием</li>
